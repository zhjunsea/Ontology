#!/usr/bin/env bash
# 运行 PrecomputeProbe2（复刻 ReasonerService 的一次性 9 类型 precompute）
...
TBOX="D:/work/Ontology/TraditionalChineseMedicineOntologyBasedonReasonerMiniBOxTBoxABox/ontology/tcm-all.owl"
{
  ...
  echo '-cp'
  echo "\"_satout;${CP//\\/\\\\}\""
  echo 'PrecomputeProbe2'
  echo "\"$TBOX\""
} > "$H/_satout/pc2.args"

cd "$H"
"$JAVA" "@D:/work/Ontology/TraditionalChineseMedicineOntologyBasedonReasonerMiniBOxTBoxABox/OntologyMachine/_harness/_satout/pc2.args"
